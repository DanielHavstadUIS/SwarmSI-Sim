...
type FixedIdealAlphaSwarmNetwork struct {
...
func (sn *FixedIdealAlphaSwarmNetwork) CreateSwarmNetwork() {
...
func (sn *FixedIdealAlphaSwarmNetwork) SelectNeighbourhood() *neighbourhood {
...
func (sn *FixedIdealAlphaSwarmNetwork) SelectWinner() *node {
...
func (sn *FixedIdealAlphaSwarmNetwork) GetNodeAdressMap() map[uint64]*node {
