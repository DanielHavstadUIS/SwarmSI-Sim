...
type FixedIdealBankSwarmNetwork struct {
...
func (sn *FixedIdealBankSwarmNetwork) CreateSwarmNetwork() {
...
func (sn *FixedIdealBankSwarmNetwork) SelectNeighbourhood() *neighbourhood {
...
func (sn *FixedIdealBankSwarmNetwork) SelectWinner() *node {
...
func (sn *FixedIdealBankSwarmNetwork) GetNodeAdressMap() map[uint64]*node {
